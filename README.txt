...
Note that you have to point to the Examples/InSar/CMakeLists.txt for compilation and remember to use a version of OTB with Concept Checking in ITK turned off. To do this, you have to set (under cmake Advanced Options) ITK_USE_CONCEPT_CHECKING to OFF when compiling OTB.
